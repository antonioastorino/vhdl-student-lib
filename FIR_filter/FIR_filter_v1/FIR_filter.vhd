    ...
    Port ( Xi, Ai		: in std_logic_vector (11 downto 0);
           ST_F, RST, COEFF, CLK_M : in std_logic;
			  READY, N_S, WARN1, WARN2 : out std_logic;
							test1, test2 : out std_logic_vector (11 downto 0);
...
signal wCLK_X, wCLK_A, wLD_DW, wST_MULT, wB_R, wCLK_OUT, wCLK_ACC, wOR, wAND : std_logic;
signal wM1out, wM2out : std_logic_vector (11 downto 0);
signal wPROD : std_logic_vector (23 downto 0);
...
--	wAND <= wCOUNT(5) and wCOUNT(4) and wCOUNT(3) and wCOUNT(2) and wCOUNT(1) and wCOUNT(0);
	...
	MULTIPLIER : Booth_Mult port map (wM1out, wM2out, wPROD, wST_MULT, RST, CLK_M, wB_R, WARN1);
