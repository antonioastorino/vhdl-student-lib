...
entity Counter_4b_not_RST is
	port(	CLK, RST : in std_logic;
			Count : out std_logic_vector(3 downto 0));
end Counter_4b_not_RST;
...
architecture Structural of Counter_4b_not_RST is
...
begin
	...
	State : PIPO_4_not_RST port map (NextState, CLK, RST, CurrentState);
	Count <= CurrentState;
end Structural;